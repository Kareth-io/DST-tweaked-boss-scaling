-- This file is a slightly tweaked version of the source scripts/prefab/klaus_sack.lua
-- The modded section of this code will be marked by comments below "Modded code start" & "Modded code end"
...
local function onuseklauskey(inst, key, doer)
    ...
    elseif key.components.klaussackkey.truekey then
        ...
        local minimum_rounds = #AllPlayers / 2
        local count = math.random(minimum_rounds, #AllPlayers)

        print("Found: " .. #AllPlayers .. " Players")
        print("Count: " .. count)
        -- This is all essentially vanilla code, we're just duplicating the process a scaled amount of times.
        for i=1,count do
